...
## [0.18.2](https://github.com/mingley/pprof-rs/compare/v0.18.1...v0.18.2) - 2026-09-05

### Other

- set CARGO_REGISTRY_TOKEN at job level in release-plz workflow

## [0.18.1] - 2026-09-04

### Fixed
- Fixed instruction pointer (`pc`) retrieval on Linux `aarch64` in `framehop_unwinder`: read `uc_mcontext.pc` instead of Link Register `regs[30]`, ensuring the innermost active frame is accurately recorded.
...
### Changed
- Updated crate author contact information.
- Refined documentation and project overview.
...
- Set MSRV to 1.88.0 (targeting Rust 1.98 toolchain).
